...
class Graph
  {
    ...
    void insert_begin(graphVertex *runner)
    {
        node *newnode = new node;
        newnode->topvertex = runner;
        newnode->next_node = list->first_node;
    ...
    void display_topograph()
    {
        node *runner_node = list->first_node;
        while(runner_node != NULL)
        {
            cout<<runner_node->topvertex->data<<"--";
